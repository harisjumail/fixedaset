...
<body class="card-no-border">
    ...
    <section id="wrapper">
        <div class="login-register" style="background-image:url(<?php echo base_url();?>assets/images/background/login-register.jpg);">
            <div class="login-box card">
                <div class="card-body">
                    <form class="form-horizontal form-material" id="loginform" action="<?php echo base_url(); ?>register/validation" method="post">
           ...
           <h6 class="card-subtitle">Registrasi Online Sekolah Dian Harapan</h6>                        
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
           <input type="text" name="user_name" class="form-control" required placeholder="Nama" value="<?php echo set_value('user_name'); ?>" maxlength="50" />
      ...
      <input type="text" name="user_email" class="form-control" required placeholder="Email" value="<?php echo set_value('user_email'); ?>" maxlength="50" />
 ...
 <input type="password" name="user_password" class="form-control" required placeholder="Password" value="<?php echo set_value('user_password'); ?>" maxlength="20" />
      <span class="text-danger"><?php echo form_error('user_password'); ?></span>                            
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
    <input class="form-control" name="confirm_password" type="password" required placeholder="Confirm Password" maxlength="20">
		<span class="text-danger"><?php echo form_error('confirm_password'); ?></span>                                 
            ...
            Sudah punya account? <a href="<?php echo base_url();?>" class="text-info m-l-5"><b>Masuk</b></a>
                     <!--       </div> -->
                        </div>
                    </form>
                </div>
