 ...
 <tr>
   ...
   <form id="form<?php echo $invoice->main_id;?>" action="<?php echo base_url();?>private_area/confirm" method="post">
 <!--  
    <button type="submit" name="konfirm" class="btn waves-effect waves-light btn-sm btn-info" value="<?php echo $row->main_id?>kirim">Konfirmasi</button>     -->
     ...
     <button class="btn btn-danger" type="submit"  name="konfirm" value="<?php echo $invoice->main_id?>kirim">Konfirmasi Pembayaran </button>   
